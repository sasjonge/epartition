...
/**
 * Manages and removes upper level ontology. They can be removed as a heuristic
 * in the partitioner
 * 
 * @author sascha
 *
...
public class UpperLevelManager {
	...
	/**
	 * Given an ontology, check how much of the known upper level ontologies it
	 * contains
	 * 
	 * @param ontology
	...
	public Map<String, Double> checkForUpperLevel(OWLOntology ontology) {
		...
		System.out.println(upperLevelOntologies.size());
	...
	/**
	 * Given an ontology containing an upper level ontology, at it to the known
