...
class TopObjectPropertyAxiomsTest extends PartitioningTest {
	
	@Test
	void objectPropertyDomainWithTopTest() throws IOException, ExportException {
		...
		OWLObjectPropertyDomainAxiom gamma = factory.getOWLObjectPropertyDomainAxiom(r,factory.getOWLThing());
	...
	@Test
	void objectPropertyRangeWithTopTest() throws IOException, ExportException {
		OWLClass a = factory.getOWLClass(base + "A");
		OWLClass b = factory.getOWLClass(base + "B");
		OWLObjectProperty r = factory.getOWLObjectProperty(base + "r");
		OWLObjectProperty s = factory.getOWLObjectProperty(base + "s");
		...
		OWLSubObjectPropertyOfAxiom alpha = factory.getOWLSubObjectPropertyOfAxiom(r, s);
		OWLSubClassOfAxiom beta = factory.getOWLSubClassOfAxiom(a, b);
		OWLObjectPropertyRangeAxiom gamma = factory.getOWLObjectPropertyRangeAxiom(s, factory.getOWLThing());
