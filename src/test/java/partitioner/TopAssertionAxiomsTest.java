...
class TopAssertionAxiomsTest extends PartitioningTest {
    
    @Test
    void classAssertionWithTopTest() throws IOException, ExportException {
		...
		OWLClassAssertionAxiom gamma = factory.getOWLClassAssertionAxiom(factory.getOWLThing(), aInd);
